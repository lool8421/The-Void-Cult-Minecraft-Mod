...
public class EnderCultistHelmetItem extends ArmorItem {

    public EnderCultistHelmetItem(Holder<ArmorMaterial> material, Type type, Properties properties) {
    ...
    private static Holder<ArmorMaterial> register(String name, EnumMap<ArmorItem.Type, Integer> typeProtection,
        ...
        ResourceLocation location = ResourceLocation.fromNamespaceAndPath(TheVoidCult.MOD_ID, name);
